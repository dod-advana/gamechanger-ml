...
def get_agencies(file_dataframe, doc_dups, duplicates, agencies_dict):
    ...
    Args:
        file_dataframe: dataframe generated by responsibilities.py for a given set of documents
...
def get_references(file_dataframe, doc_title_col='doc'):
    ...
    Args:
        file_dataframe: dataframe generated by responsibilities.py for a given set of documentss
...
def check_duplicates(text, duplicates, agencies_dict):
    """
    For a given text, checks to see if there are duplicate agencies and returns proper agency or agency abbreviation.

    Args:
        text: raw text of file from input json
        duplicates: list of acronyms with multiple associated agencies
        agencies: agencies file based around columns "Agency_Aliases" and "Agency_Names"
