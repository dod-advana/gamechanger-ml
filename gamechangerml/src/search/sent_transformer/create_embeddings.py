...
def main():
    ...
    parser.add_argument(
        ...
        default=False,
        type=bool,
        help="Use new Sentence Corpus Parser"
    )
    ...
    encoder.index_documents(args.corpus, new_index_dir, new_parser = args.new_parser)
...
def main2():
    ...
    parser.add_argument(
        ...
        required=True,
        type=str,
        help="Folder path containing old GC Corpus",
    )
    parser.add_argument(
        "-e",
        "--existing-embeds",
    ...
    parser.add_argument(
        ...
        dest="encoder_model",
        required=False,
        default="sentence-transformers/msmarco-distilbert-base-v2",
        type=str,
        help="Encoder model used to encode the dataset",
    )
    parser.add_argument(
    ...
    #logger.info("Loading Encoder Model...")
    encoder = SentenceEncoder(args.encoder_model, use_gpu)
    #logger.info("Creating Document Embeddings...")
    encoder.new_index_documents(args.corpus, args.old_corpus, new_index_dir, new_parser = args.new_parser)
