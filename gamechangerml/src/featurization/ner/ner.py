...
class LocalNERConfig:

    CORPUS_DIR = "/Users/katherinedowdy/Documents/Gamechanger/corpus_dod_docs"
    GRAPH_DATA_PATH = "/Users/katherinedowdy/Documents/GameChanger/gamechanger-ml/gamechangerml/data/features/GraphRelations.xls"
    ENTITIES_PATH = "/Users/katherinedowdy/Documents/Gamechanger/gamechanger-ml/gamechangerml/data/ner/entities.json"
    BASE_MODEL_NAME = "distilroberta-base"
    OUTPUT_DIR = "/Users/katherinedowdy/Documents/Gamechanger/gamechanger-ml/gamechangerml/data/ner"
...
class NERExtractor():
    ...
    def __init__(self, base_model_name, tuned_model_loc, num_labels=5):
    ...
    def predict_entities(self, string):
        ...
        for _ in range(len(results)):
            if remaining > 0:
                ...
                if res['entity_group'] == 'LABEL_1':
                    ...
                    hits.append({"label": label, "span": token_span, "text": text, "score": avg_score})
...
if __name__ == "__main__":
    ...
    parser.add_argument("--job", "-j", dest="job", help="which process to run - options = ['make_data', 'train', 'evaluate']")
    ...
    if args.env == 'remote':
        print("Setting config to remote")
        BaseConfig = RemoteNERConfig
    else:
        print("setting config to local")
        BaseConfig = LocalNERConfig
