...
function setup_prod() {
    ...
    export S3_DOC_COMPARE_SENT_INDEX_PATH="${S3_DOC_COMPARE_SENT_INDEX_PATH:-s3://advana-data-zone/bronze/gamechanger/models/doc_compare_sent_index/v2/doc_compare_sent_index_20220427.tar.gz}"
...
cat <<EOF
  ...
  * S3_DOC_COMPARE_SENT_INDEX_PATH: ${S3_DOC_COMPARE_SENT_INDEX_PATH:-<unset>}"
