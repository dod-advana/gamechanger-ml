...
function setup_prod() {
    ...
    export S3_NER_MODEL_PATH="${S3_NER_MODEL_PATH:-s3://advana-data-zone/bronze/gamechanger/models/ner/v1/distilroBERTa_ner_20220414.tar.gz}"
    export S3_NER_TOKENIZER_PATH="${S3_NER_TOKENIZER_PATH:-s3://advana-data-zone/bronze/gamechanger/models/ner/v1/distilroberta-base.tar.gz}"
...
cat <<EOF
  ...
  * S3_NER_MODEL_PATH: ${S3_NER_MODEL_PATH:-<unset>}"
  * S3_NER_TOKENIZER_PATH: ${S3_NER_TOKENIZER_PATH:-<unset>}"
